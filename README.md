...
- **Updates itself**: when there is a new version, one click installs it and keeps your data
...
| See your real grade in each class, and what you need on the final (optional, beta) | **⚙ Settings → Features → Grades**, see below |
| Update right now | **↻ Refresh** (about 2 minutes) |
| Get the newest version of the dashboard | When there is one, **Update available** appears at the top; click it, then **Update now** (your data is kept). Coming from v1.4 or older? Update once the old way (ask your agent to "update the dashboard"); from then on it’s one click |
